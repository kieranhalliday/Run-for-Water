...
public class EnterDetailedWellData extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String target = getIntent().getExtras().getString("Current User");
        Gson gS = new Gson();
        ...
        Button sendData1 = (Button) findViewById(R.id.sendData1);
        Button switchScreens = (Button) findViewById(R.id.switchViews);
        Button switchScreens1 = (Button) findViewById(R.id.switchViews1);
    ...
    public void setListeners() {
        wellName = (EditText) findViewById(R.id.well_name);
        cdnGroup = (EditText) findViewById(R.id.cdnGroup);
        streetAddress = (EditText) findViewById(R.id.street_address);
        town = (EditText) findViewById(R.id.town);
        county = (EditText) findViewById(R.id.county);
        typeOfProperty = (EditText) findViewById(R.id.typeOfProperty);
        localTerrain = (EditText) findViewById(R.id.localTerrain);
        contactName = (EditText) findViewById(R.id.contactName);
        contactCell = (EditText) findViewById(R.id.contactCell);
        drillingStartDate = (EditText) findViewById(R.id.drilling_start_date);
        drillingFinishDate = (EditText) findViewById(R.id.drillingFinishDate);
        comments = (EditText) findViewById(R.id.comments);
        pumpInstallationDate = (EditText) findViewById(R.id.pumpInstallationDate);
        numberOfDaysDrilling = (EditText) findViewById(R.id.numberOfDaysDrilling);
        averageDrillingPerDayInMeters = (EditText) findViewById(R.id.averageDrillingPerDayInMeters);
        depth = (EditText) findViewById(R.id.depth);
        depthToWater = (EditText) findViewById(R.id.depthToWater);
        depthOfPumpIntake = (EditText) findViewById(R.id.depthOfPumpIntake);
        locationRelativeToSlope = (EditText) findViewById(R.id.locationRelativeToSlope);
        depthToBedrock = (EditText) findViewById(R.id.depthToBedrock);
        depthDrilledIntoBedRock = (EditText) findViewById(R.id.depthDrilledIntoBedRock);
        numberOfNearbyWells = (EditText) findViewById(R.id.numberOfNearbyWells);
        idOfNearbyWells = (EditText) findViewById(R.id.idOfNearbyWells);
        wellWaterColumn = (EditText) findViewById(R.id.wellWaterColumn);
        rockBitUsed = (EditText) findViewById(R.id.rockbit);
    }
}
